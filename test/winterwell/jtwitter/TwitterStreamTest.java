...
public class TwitterStreamTest {
	...
	public void testthins(){
		String lon = "#winfromwithin, manchester gatorade, utd gatorade, united gatorade, mufc gatorade, simeon williamson, powerbaruk, recovery drink milk, sports nutrition milk, protein recovery milk, manchester united, manchester utd, johanna jackson walking, johanna jackson walker, jo jackson walker walking, jo jackson walker walker, london irish rugby, cycling team sky, rider team sky, iwan thomas, hydration #lia2012, drink #lia2012, worcester rugby, worcester warriors, gssi tip of the day, gatorade tip of the day, myproteinuk, tim brabants, ggreenbottle, gatorade joannejackson86, gatoradeuk and track cycling, gatoradeuk and track pendleton, gatoradeuk and track v_pendleton, gatorade and track cycling, gatorade and track pendleton, gatorade and track v_pendleton, gatorade uk cycling, gatorade uk pendleton, gatorade uk v_pendleton, gatorade cycling, gatorade pendleton, gatorade v_pendleton, masterclass cycling, masterclass pendleton, masterclass v_pendleton, gatoradeuk cycling, gatoradeuk pendleton, gatoradeuk v_pendleton, victoria pendleton, gatorade proftimnoakes, hydration proftimnoake";
		List<String> lis = StrUtils.splitOnComma(lon);
	...
	public void testTooManyKeywords2_R6Probes() throws InterruptedException, FileNotFoundException{
		...
		List<String> terms = StrUtils.splitOnComma(longString);
